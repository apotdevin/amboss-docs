...
The raspiblitz team has prepared specific installation instructions for the latest raspiblitz version [here](https://gist.github.com/openoms/2b3a83089e2217349ece264b254eb478).
...
In a web browser, navigate to your node’s local IP with port 3040 by default:
