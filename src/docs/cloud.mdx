...
![Create a Droplet](/assets/docs/cloud/DO-create-droplet.png)

Using the Marketplace tab, select a Docker image deployment on Ubuntu.

![Docker Droplet](/assets/docs/cloud/DO-droplet-docker.png)

The $10/month plan provides sufficient resources to make full use of the Amboss toolset.

![Droplet Plan](/assets/docs/cloud/DO-droplet-plan.png)
...
_ Must contain 1 uppercase (first and last characters don’t count)
_ Must contain 1 number
_ Cannot end in a number or special character

![Droplet Authentication](/assets/docs/cloud/DO-droplet-password.png)
...
Complete the installation on Digital Ocean, use the [Standalone Installation](/docs/standalone).
