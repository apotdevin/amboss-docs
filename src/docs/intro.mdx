...
Amboss can be installed on a physical node (such as a [Raspiblitz](/docs/raspiblitz)) or can be installed on a virtual private server (VPS) like [DigitalOcean](/docs/CloudNode).
