...
Amboss can be installed on a physical node (such as a [Raspiblitz](/docs/raspiblitz)) or can be installed on a [standalone system](/docs/standalone) like a virtual private server (VPS) such as [DigitalOcean](/docs/cloud). For a custom implementation, use the [Basic Installation](/docs/basic).
